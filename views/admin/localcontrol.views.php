...
<main class=" p-5 w-full h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid ">
        ...
        <div class="px-6 my-6 flex justify-between ">
            <a href="/localassigne" class="no-underline text-white">
                <button class="flex items-center justify-between w-60 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-900 hover:bg-red-900 focus:outline-none focus:shadow-outline-purple">
                    Assign
            ...
            <!-- Adduser -->
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="flex items-center justify-between w-60 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple">
                Ajout Locals
                <span class="ml-2" aria-hidden="true">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <form class="space-y-2" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">nom
                                    local</label>
                                <input type="name" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600  " placeholder="Nom" required>
                            </div>


                            <label for="placement" class="block mb-2 text-sm font-medium text-gray-900">Select
                                placement</label>
                            <select name="placement" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
        ...
        <!-- seach sh -->
        <div class="flex-auto">
            <form class="flex items-center" method="POST" action="/localcontrol">
                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            ...
                            <th class="px-4 py-3">Plcement</th>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <div class="relative hidden w-40 h-20 rounded-full md:block">
                                            <img class=" object-contain w-full h-full rounded-lg" src="<?= $local['image'] ?>" alt="" loading="lazy" />
                                ...
                                <td class="px-4 py-3 text-sm">
                                    ...
                                    <form class="space-y-2" action="" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <input type="hidden" name="id_local" value="<?= $local['id_local'] ?>">
                                        <input type="hidden" name="old_name" value="<?= $local['name'] ?>">
                                        <input type="hidden" name="old_placement" value="<?= $local['placement'] ?>">
                                        <input type="hidden" name="old_image" value="<?= $local['image'] ?>">
                                        <!-- Main modal -->
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        <div class="px-6 py-6 lg:px-8">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="name" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600  " placeholder="the category name">
                                                            </div>
                                                            <div>
                                                                <label for="placement" class="block mb-2 text-sm font-medium text-gray-900 ">placement</label>
                                                                <input type="placement" name="placement" id="placement" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600  " placeholder="placement">
                                                            </div>

                                                            <label for="dropzone-file<?= $x ?>" class="block mb-2 text-sm font-medium text-gray-900 ">
                                                                picture
                                                            </label>
                                                            <div class="flex items-center justify-center w-full">
