    ...
    <div class="container px-6 mx-auto grid ">
        ...
        <div class="px-6 my-6 flex justify-between ">
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                class="flex items-center justify-between w-60 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none focus:shadow-outline-purple">
                Ajouter Category
                ...
                <div class="relative w-full h-full max-w-md md:h-auto">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                            <h3 class="mb-4 text-xl font-medium text-gray-900 ">Add new Category to our platform</h3>
                            <form class="space-y-2" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <label for="dropzone-file" class="block mb-2 text-sm font-medium text-gray-900 ">image
                                </label>
                ...
                <tbody class="text-left bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                                ...
                                <div class="relative hidden w-20 h-20  rounded-full md:block">
                                    <img class=" object-cover w-full h-full rounded-lg" src="<?= $category['image'] ?>"
                                        alt="" loading="lazy" />
                        ...
                        <td class="px-4 py-3 text-sm">
                            ...
                            <button data-modal-target="popup-modal<?= $x ?>" data-modal-toggle="popup-modal<?= $x ?>"
