...
$db->query('DELETE FROM localequipment WHERE unique_id = :unique_id', ['unique_id' => $unique_id]);
...
// Redirect back to the office page
header('location: /myoffice?id=' . $id_local . '&offices=' . $local_name);
exit();
